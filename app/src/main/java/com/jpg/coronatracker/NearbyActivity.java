...
public abstract class NearbyActivity extends AppCompatActivity {
    ...
    private final ConnectionLifecycleCallback mConnectionLifecycleCallback =
            new ConnectionLifecycleCallback() {
                    ...
                    if (!result.getStatus().isSuccess()) {
                        logW(
                                String.format(
                                        ...
                                        NearbyActivity.toString(result.getStatus())));
                        onConnectionFailed(mPendingConnections.remove(endpointId));
                        return;
                    }
                    connectedToEndpoint(mPendingConnections.remove(endpointId));
                    // we may add it to another list so that we do not connect to it again.
                }
                ...
                public void onDisconnected(String endpointId) {
                    ...
                    // Here we can add to another list so that we do not connect again in next 24 hours (or is this needed?)
                }
            };
    ...
    //needed when already connected in last 24 hours (or any other time limit)
    ...
    protected void logV(String msg) {
        Log.v("CoronaTracker", msg);
    }

    @CallSuper
    protected void logD(String msg) {
        Log.d("CoronaTracker", msg);
    }

    @CallSuper
    protected void logW(String msg) {
        Log.w("CoronaTracker", msg);
    }

    @CallSuper
    protected void logW(String msg, Throwable e) {
        Log.w("CoronaTracker", msg, e);
    }

    @CallSuper
    protected void logE(String msg, Throwable e) {
        Log.e("CoronaTracker", msg, e);
    }
